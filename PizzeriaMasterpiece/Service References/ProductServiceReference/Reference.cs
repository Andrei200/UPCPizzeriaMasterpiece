...
namespace PizzeriaMasterpiece.ProductServiceReference {
    ...
    public interface IProductService {
        ...
        PizzeriaMasterpiece.ProductServiceReference.ProductDTO GetProductInformation(int productId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProductService/GetProductInformation", ReplyAction="http://tempuri.org/IProductService/GetProductInformationResponse")]
        System.Threading.Tasks.Task<PizzeriaMasterpiece.ProductServiceReference.ProductDTO> GetProductInformationAsync(int productId);
        ...
        PizzeriaMasterpiece.ProductServiceReference.ProductDTO InsertProductInformation(PizzeriaMasterpiece.ProductServiceReference.ProductDTO product);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProductService/InsertProductInformation", ReplyAction="http://tempuri.org/IProductService/InsertProductInformationResponse")]
        System.Threading.Tasks.Task<PizzeriaMasterpiece.ProductServiceReference.ProductDTO> InsertProductInformationAsync(PizzeriaMasterpiece.ProductServiceReference.ProductDTO product);
        ...
        PizzeriaMasterpiece.ProductServiceReference.ProductDTO UpdateProductInformation(PizzeriaMasterpiece.ProductServiceReference.ProductDTO product);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProductService/UpdateProductInformation", ReplyAction="http://tempuri.org/IProductService/UpdateProductInformationResponse")]
        System.Threading.Tasks.Task<PizzeriaMasterpiece.ProductServiceReference.ProductDTO> UpdateProductInformationAsync(PizzeriaMasterpiece.ProductServiceReference.ProductDTO product);
        ...
        PizzeriaMasterpiece.ProductServiceReference.ProductDTO[] ListAllProductInformation();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IProductService/ListAllProductInformation", ReplyAction="http://tempuri.org/IProductService/ListAllProductInformationResponse")]
        System.Threading.Tasks.Task<PizzeriaMasterpiece.ProductServiceReference.ProductDTO[]> ListAllProductInformationAsync();
    }
    ...
    public partial class ProductServiceClient : System.ServiceModel.ClientBase<PizzeriaMasterpiece.ProductServiceReference.IProductService>, PizzeriaMasterpiece.ProductServiceReference.IProductService {
        ...
        public PizzeriaMasterpiece.ProductServiceReference.ProductDTO GetProductInformation(int productId) {
            return base.Channel.GetProductInformation(productId);
        }
        
        public System.Threading.Tasks.Task<PizzeriaMasterpiece.ProductServiceReference.ProductDTO> GetProductInformationAsync(int productId) {
            return base.Channel.GetProductInformationAsync(productId);
        }
        
        public PizzeriaMasterpiece.ProductServiceReference.ProductDTO InsertProductInformation(PizzeriaMasterpiece.ProductServiceReference.ProductDTO product) {
            return base.Channel.InsertProductInformation(product);
        }
        
        public System.Threading.Tasks.Task<PizzeriaMasterpiece.ProductServiceReference.ProductDTO> InsertProductInformationAsync(PizzeriaMasterpiece.ProductServiceReference.ProductDTO product) {
            return base.Channel.InsertProductInformationAsync(product);
        }
        
        public PizzeriaMasterpiece.ProductServiceReference.ProductDTO UpdateProductInformation(PizzeriaMasterpiece.ProductServiceReference.ProductDTO product) {
            return base.Channel.UpdateProductInformation(product);
        }
        
        public System.Threading.Tasks.Task<PizzeriaMasterpiece.ProductServiceReference.ProductDTO> UpdateProductInformationAsync(PizzeriaMasterpiece.ProductServiceReference.ProductDTO product) {
            return base.Channel.UpdateProductInformationAsync(product);
        }
        
        public PizzeriaMasterpiece.ProductServiceReference.ProductDTO[] ListAllProductInformation() {
            return base.Channel.ListAllProductInformation();
        }
        
        public System.Threading.Tasks.Task<PizzeriaMasterpiece.ProductServiceReference.ProductDTO[]> ListAllProductInformationAsync() {
